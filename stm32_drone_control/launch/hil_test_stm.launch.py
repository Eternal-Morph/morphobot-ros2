...
def generate_launch_description():
    ...
    use_rviz_arg = DeclareLaunchArgument(
        'use_rviz',
        default_value='true',
        description='RViz2 görselleştirmesini başlat'
    )
    ...
    baudrate_arg = DeclareLaunchArgument(
        ...
        description='STM32 Seri Port Baud Rate'
    )

    use_bridge_arg = DeclareLaunchArgument(
        'use_bridge',
        default_value='true',
        description='STM32 Gamepad HIL Bridge düğümünü başlat'
    )
    ...
    # Gamepad & STM32 HIL Köprüsü Düğümü
    hil_bridge_node = Node(
        package='stm32_drone_control',
        executable='hil_gamepad_stm_bridge',
        name='hil_gamepad_stm_bridge',
        output='screen',
        parameters=[{
